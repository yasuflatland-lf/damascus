<%-- <dmsc:root templateName="Portlet_XXXXWEB_admin_init.jsp.ftl"  /> --%>
<%-- <dmsc:sync id="head-common" > --%>
<#include "./valuables.ftl">
<#assign createPath = "${webModulePath}/src/main/resources/META-INF/resources/sample_sb_admin/init.jsp">
<%-- </dmsc:sync> --%>
