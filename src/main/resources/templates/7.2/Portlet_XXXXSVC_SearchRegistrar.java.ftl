...
public class ${capFirstModel}SearchRegistrar extends BaseSearcher {

	@Activate
	protected void activate(BundleContext bundleContext) {
		_serviceRegistration = modelSearchRegistrarHelper.register(${capFirstModel}.class, bundleContext, modelSearchDefinition -> {
