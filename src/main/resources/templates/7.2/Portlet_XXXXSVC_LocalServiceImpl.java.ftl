...
public class ${capFirstModel}LocalServiceImpl extends ${capFirstModel}LocalServiceBaseImpl {
	...
	public ${capFirstModel} get${capFirstModel}FromRequest(
		...
		try {
			...
			entry.setSamplesbBooleanStat(
				ParamUtil.getBoolean(request, "${lowercaseModel}BooleanStat"));
			entry.setSamplesbDateTime(
				getDateTimeFromRequest(request, "${lowercaseModel}DateTime"));
			entry.setSamplesbDocumentLibrary(
				ParamUtil.getString(request, "${lowercaseModel}DocumentLibrary"));
			entry.setSamplesbDouble(
				ParamUtil.getDouble(request, "${lowercaseModel}Double"));
			entry.setSamplesbInteger(
				ParamUtil.getInteger(request, "${lowercaseModel}Integer"));
			entry.setSamplesbRichText(
	...
	protected ${capFirstModel} _updateEntry(
		...
		updateEntry.setSamplesbDocumentLibrary(
