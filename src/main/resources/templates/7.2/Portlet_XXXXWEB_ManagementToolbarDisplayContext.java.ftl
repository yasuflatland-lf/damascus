		...
		return new DropdownItemList() {
			{
				...
				add(
					dropdownItem -> {
						dropdownItem.setActive(
							Objects.equals(
								getOrderByCol(), "${lowercaseModel}BooleanStat"));
						dropdownItem.setHref(
							_getCurrentSortingURL(), "orderByCol",
							"${lowercaseModel}BooleanStat");
						dropdownItem.setLabel(
							LanguageUtil.get(request, "${lowercaseModel}BooleanStat"));
					});
				...
				add(
					dropdownItem -> {
						dropdownItem.setActive(
							Objects.equals(
								getOrderByCol(), "${lowercaseModel}DateTime"));
						dropdownItem.setHref(
							_getCurrentSortingURL(), "orderByCol",
							"${lowercaseModel}DateTime");
						dropdownItem.setLabel(
							LanguageUtil.get(request, "${lowercaseModel}DateTime"));
					});
				add(
					dropdownItem -> {
						dropdownItem.setActive(
							Objects.equals(
								getOrderByCol(), "${lowercaseModel}DocumentLibrary"));
						dropdownItem.setHref(
							_getCurrentSortingURL(), "orderByCol",
							"${lowercaseModel}DocumentLibrary");
						dropdownItem.setLabel(
							LanguageUtil.get(
								request, "${lowercaseModel}DocumentLibrary"));
					});
				add(
					dropdownItem -> {
						dropdownItem.setActive(
							Objects.equals(getOrderByCol(), "${lowercaseModel}Double"));
						dropdownItem.setHref(
							_getCurrentSortingURL(), "orderByCol",
							"${lowercaseModel}Double");
						dropdownItem.setLabel(
							LanguageUtil.get(request, "${lowercaseModel}Double"));
					});
				add(
					dropdownItem -> {
						dropdownItem.setActive(
							Objects.equals(getOrderByCol(), "${lowercaseModel}Integer"));
						dropdownItem.setHref(
							_getCurrentSortingURL(), "orderByCol",
							"${lowercaseModel}Integer");
						dropdownItem.setLabel(
							LanguageUtil.get(request, "${lowercaseModel}Integer"));
					});
				add(
					dropdownItem -> {
						dropdownItem.setActive(
							Objects.equals(
								getOrderByCol(), "${lowercaseModel}RichText"));
						dropdownItem.setHref(
							_getCurrentSortingURL(), "orderByCol",
							"${lowercaseModel}RichText");
						dropdownItem.setLabel(
							LanguageUtil.get(request, "${lowercaseModel}RichText"));
					});
				add(
					dropdownItem -> {
						dropdownItem.setActive(
							Objects.equals(getOrderByCol(), "${lowercaseModel}Text"));
						dropdownItem.setHref(
							_getCurrentSortingURL(), "orderByCol",
							"${lowercaseModel}Text");
						dropdownItem.setLabel(
							LanguageUtil.get(request, "${lowercaseModel}Text"));
					});
			}
		};
	}
