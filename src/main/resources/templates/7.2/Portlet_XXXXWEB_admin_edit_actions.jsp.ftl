<%-- <dmsc:root  templateName="Portlet_XXXXWEB_admin_edit_actions.jsp.ftl" /> --%>
<%-- <dmsc:sync id="head-common" > --%>
<#include "./valuables.ftl">
<#assign createPath = "${webModulePath}/src/main/resources/META-INF/resources/sample_sb_admin/edit_actions.jsp">
<%-- </dmsc:sync> --%>
