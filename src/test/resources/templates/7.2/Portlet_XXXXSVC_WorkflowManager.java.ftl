// <dmsc:root templateName="Portlet_XXXXSVC_WorkflowManager.java.ftl"  />
...
public class ${capFirstModel}WorkflowManager {
	...
	static public boolean isWorkflowEnable(
		...
		List<String> transitionNames = getTransitionNames(
	 ...
	 * @throws PortalException
	 */
	static public List<String> getTransitionNames(
			User user, long scorpGroupId, long classPK)
		throws PortalException {
	 ...
	 * @throws WorkflowException
	 */
	static public List<WorkflowTask> getWorkflowTasks(
		...
		List<WorkflowTask> workflowTasksToMyRoles = getWorkflowTasks(
			user, className, true);
		...
		List<WorkflowTask> workflowTasksToMe = getWorkflowTasks(
